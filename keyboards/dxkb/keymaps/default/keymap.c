...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_split_4x6_3(
	...
	LT(_QMK,KC_TAB),	MT(KC_NO,KC_Q),		MT(KC_NO,KC_W),		MT(KC_NO,KC_E),		MT(KC_NO,KC_R),		MT(KC_NO,KC_T),				MT(KC_NO,KC_Y),		MT(KC_NO,KC_U),		MT(KC_NO,KC_I),		MT(KC_NO,KC_O),		MT(KC_NO,KC_P),		MT(KC_NO,KC_LBRC),
	KC_LSFT,			MT(KC_NO,KC_A),		MT(KC_NO,KC_S),		MT(KC_NO,KC_D),		MT(KC_NO,KC_F),		MT(KC_NO,KC_G),				MT(KC_NO,KC_H),		MT(KC_NO,KC_J),		MT(KC_NO,KC_K),		MT(KC_NO,KC_L),		MT(KC_NO,KC_SCLN),	MT(KC_NO,KC_QUOT),
	KC_LCTL,			MT(KC_NO,KC_Z),		MT(KC_NO,KC_X),		MT(KC_NO,KC_C),		MT(KC_NO,KC_V),		MT(KC_NO,KC_B),				MT(KC_NO,KC_N),		MT(KC_NO,KC_M),		MT(KC_NO,KC_COMM),	MT(KC_NO,KC_DOT),	MT(KC_NO,KC_SLSH),	MT(KC_NO,KC_EQL),
																KC_LEFT_ALT,		KC_LEFT_GUI,		LT(_NAV,KC_SPACE),			LT(_FUNC,KC_ENTER),	KC_BACKSPACE,		KC_RIGHT_ALT
  ),
